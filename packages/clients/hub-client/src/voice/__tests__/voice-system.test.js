...
import { VoiceSystem, VoiceParticipantComponent, VoiceLocalComponent } from '../voice-system';
import { World, TransformComponent } from '../../ecs';
...
class MockVoiceChatClient {
    ...
    setConnected(connected) { this.connected = connected; this.emit('connected'); }
...
describe('VoiceSystem', () => {
    ...
    beforeEach(() => {
        world = new World();
        mockVoiceClient = new MockVoiceChatClient();
        config = {
            maxDistance: 10,
            spatialAudioEnabled: true,
            voiceActivityEnabled: true,
        };
        voiceSystem = new VoiceSystem(mockVoiceClient, config);
    ...
    describe('Initialization', () => {
        ...
        it('should have default config', () => {
            const defaultSystem = new VoiceSystem(mockVoiceClient);
        ...
        it('should accept custom config', () => {
            ...
            const customSystem = new VoiceSystem(mockVoiceClient, customConfig);
    ...
    describe('Spatial Audio Updates', () => {
        ...
        it('should not update position when spatial audio disabled', () => {
            const noSpatialSystem = new VoiceSystem(mockVoiceClient, {
                spatialAudioEnabled: false,
            });
            // Mock emit method
    ...
    describe('Speaking State Updates', () => {
        ...
        it('should not emit speaking events when voice activity disabled', () => {
            const noVADSystem = new VoiceSystem(mockVoiceClient, {
                voiceActivityEnabled: false,
            });
            // Mock emit method
    ...
    describe('Edge Cases', () => {
        it('should handle update with no world', () => {
            const standaloneSystem = new VoiceSystem(mockVoiceClient);
