...
export function FPSCounter() {
    ...
    return (_jsxs("div", { style: {
            ...
            userSelect: 'none',
            minWidth: '120px',
        }, children: [_jsx("div", { style: { marginBottom: '4px', fontWeight: 'bold' }, children: "Performance" }), _jsxs("div", { style: { color: fpsColor }, children: [fps, " FPS ", _jsxs("span", { style: { color: '#888', fontSize: '12px' }, children: ["(", fpsStatus, ")"] })] }), _jsxs("div", { style: { color: '#aaa', fontSize: '12px' }, children: [frameTime, "ms/frame"] })] }));
}
