...
describe('PhysicsWorld', () => {
  ...
  it('should add and remove bodies', () => {
    const body = new (window as any).CANNON.Body({
      mass: 1,
      position: new (window as any).CANNON.Vec3(0, 5, 0),
    });
  ...
  it('should perform raycast', () => {
    ...
    const body = new (window as any).CANNON.Body({
      mass: 0,
      position: new (window as any).CANNON.Vec3(0, 0, 0),
    });
    body.addShape(new (window as any).CANNON.Box(new (window as any).CANNON.Vec3(1, 1, 1)));
    world.addBody(body);

    // Raycast down
    const from = new (window as any).CANNON.Vec3(0, 5, 0);
    const to = new (window as any).CANNON.Vec3(0, -5, 0);
...
describe('PhysicsBodyComponent', () => {
  ...
  it('should apply force', () => {
    ...
    expect(() => component.applyForce({ x: 0, y: 10, z: 0 } as any)).not.toThrow();
  });
  ...
  it('should apply impulse', () => {
    ...
    expect(() => component.applyImpulse({ x: 5, y: 0, z: 0 } as any)).not.toThrow();
  });
  ...
  it('should set and get velocity', () => {
    ...
    component.setVelocity({ x: 1, y: 2, z: 3 } as any);
  ...
  it('should simulate stacked boxes', () => {
    ...
    for (let i = 0; i < stackHeight; i++) {
      ...
      const boxBody = new PhysicsBodyComponent({
        mass: 1,
        shape: 'box',
        size: { x: boxSize, y: boxSize, z: boxSize } as any,
      });
